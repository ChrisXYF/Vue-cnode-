  ...
  <div class="SideBar">
    ...
    <div v-else class="autherinfo">
      <div class="authersummay">
        <p>作者</p>
        <router-link :to="{ name: 'writerinfo', params: { name: userinfo.loginname }}">
          <img :src="userinfo.avatar_url">
        </router-link>
        <router-link
          :to="{ name: 'writerinfo', params: { name: userinfo.loginname }}"
      ...
      <div class="recent_topics">
        ...
        <ul>
          <li v-for="list in topicsLimitBy5">
            <router-link
              :to="{ name: 'mesContent', params: { id: list.id,name:list.author.loginname }}"
              :title="list.title"
